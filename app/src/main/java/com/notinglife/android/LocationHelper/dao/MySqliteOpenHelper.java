...
public class MySqliteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //
        db.execSQL("CREATE TABLE devices (_id integer primary key autoincrement, deviceId varchar(10), macAddress varchar(20)," +
                " latitude varchar(16), longitude varchar(16), owner varchar(20), deviceStatus varchar(10));");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        //添加一个phone字段
        //db.execSQL("alter table devices add username varchar(20)");
